...
The task panel also exposes the **Attachment** section (inherited from `Part::AttachExtension`), which controls the position of the sphere centre. See the [Attachment](../concepts/attachment.md) documentation for the full list of modes. <!-- TODO: verify link -->
