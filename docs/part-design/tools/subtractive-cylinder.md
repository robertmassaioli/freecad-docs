...
The task panel also exposes the **Attachment** section (inherited from `Part::AttachExtension`), which controls the position and orientation of the cylinder's axis. See the [Attachment](../concepts/attachment.md) documentation for the full list of modes. <!-- TODO: verify link -->
