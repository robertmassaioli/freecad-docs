...
- [Body, Origin and Feature Tree](../concepts/body-and-origin.md) — the built-in X, Y, Z origin axes
- [Attachment](../concepts/attachment.md) — the attachment mode reference for all datum objects
