...
- [New Assembly](new-assembly.md) — create the assembly and insert parts first
- [Fixed Joint](joint-fixed.md) — lock two parts together with no motion
- [Revolute Joint](joint-revolute.md) — constrain relative motion between parts after grounding
