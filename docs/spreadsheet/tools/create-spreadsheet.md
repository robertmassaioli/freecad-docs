...
- Formulas and Expressions — formula syntax reference
- Aliases — naming cells for external references
- Model Integration — linking spreadsheet values to model dimensions
